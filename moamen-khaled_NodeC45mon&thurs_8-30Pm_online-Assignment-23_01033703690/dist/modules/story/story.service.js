...
import { BlockRepository, FollowRepository, ProfileRepository, } from "../../infra/repository/index.js";
...
class StoryService {
    ...
    async uploadStory(inputs) {
        ...
        if (!story) {
            throw new InternalServerError(`Fail to upload this story please try again later`);
        }
