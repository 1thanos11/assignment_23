...
const router = Router();
router.post("/create-group", authentication(), cloudFileUpload({ validation: fileFilterValidation.image }).single("attachment"), restFullApiValidate(chatValidation.createGroup), chatController.createGroup.bind(chatController));
