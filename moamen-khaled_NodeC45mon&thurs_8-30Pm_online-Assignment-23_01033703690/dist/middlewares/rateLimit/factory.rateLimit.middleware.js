...
import { BadRequestError, TooManyRequestsError, } from "../../common/errors/client.errors.js";
import { redisService } from "../../common/services/redis.service.js";
export const createLimiter = ({ windowMs, limit, skipSuccessfulRequests = false, skipFailedRequests = false, keyGenerator = KeyGeneratorEnum.IP, store = redisStore(windowMs), requestPropertyName = "rateLimit", }) => {
    return rateLimit({
        windowMs,
        limit,
